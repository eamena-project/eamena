	...
	def __unflatten(self, options):
		...
		if not(options['source']):
			...
			if rm is None:
				...
				expected_nodes = ['UNIQUEID', 'ASSESSMENT_INVESTIGATOR___ACTOR', 'INVESTIGATOR_ROLE_TYPE', 'ASSESSMENT_ACTIVITY_TYPE', 'ASSESSMENT_ACTIVITY_DATE', 'GE_ASSESSMENT_YES_NO_', 'GE_IMAGERY_ACQUISITION_DATE', 'INFORMATION_RESOURCE_USED', 'INFORMATION_RESOURCE_ACQUISITION_DATE', 'RESOURCE_NAME', 'NAME_TYPE', 'GENERAL_DESCRIPTION_TYPE', 'GENERAL_DESCRIPTION', 'PROCESS_INDICATOR_EVIDENCE_OF', 'PROCESS_INDICATOR_CERTAINTY', 'DESIGNATION', 'DESIGNATION_FROM_DATE', 'DESIGNATION_TO_DATE', 'GEOMETRIC_PLACE_EXPRESSION', 'GEOMETRY_QUALIFIER', 'SITE_LOCATION_CERTAINTY', 'GEOMETRY_EXTENT_CERTAINTY', 'OVERALL_LOCATION_TYPE', 'GRID_ID', 'COUNTRY_TYPE', 'MARITIME_REGION_TYPE', 'OVERALL_GEOARCHAEOLOGICAL_CERTAINTY_VALUE', 'SOURCE_OF_EVIDENCE_TYPE', 'MARINE_ISOTOPE_STAGES', 'MARINE_ISOTOPE_STAGE_CERTAINTY', 'QUATERNARY_DIVISIONS', 'QUATERNARY_DATE_CERTAINTY', 'DATE_INFERENCE_MAKING_ACTOR', 'ARCHAEOLOGICAL_DATE_FROM__CAL_', 'ARCHAEOLOGICAL_DATE_TO__CAL_', 'BP_DATE_FROM', 'BP_DATE_TO', 'AH_DATE_FROM', 'AH_DATE_TO', 'SH_DATE_FROM', 'SH_DATE_TO', 'FEATURE_SEDIMENT_TYPE', 'FEATURE_SEDIMENT_TRANSITION', 'FEATURE_SEDIMENT_TYPE_CERTAINTY', 'FEATURE_LANDFORM_TYPE', 'SITE_LANDFORM_ARRANGEMENT_TYPE', 'SITE_LANDFORM_NUMBER_TYPE', 'FEATURE_LANDFORM_TYPE_CERTAINTY', 'FEATURE_INTERPRETATION_TYPE', 'FEATURE_INTERPRETATION_CERTAINTY', 'RELATED_GEOARCHAEOLOGY_RESOURCE', 'OVERALL_CONDITION_STATE', 'DAMAGE_EXTENT_TYPE', 'DISTURBANCE_CAUSE_CATEGORY_TYPE', 'DISTURBANCE_CAUSE_TYPE', 'DISTURBANCE_CAUSE_CERTAINTY', 'DISTURBANCE_DATE_FROM', 'DISTURBANCE_DATE_TO', 'DISTURBANCE_DATE_OCCURRED_BEFORE', 'DISTURBANCE_DATE_OCCURRED_ON', 'DISTURBANCE_CAUSE_ASSIGNMENT_ASSESSOR_NAME', 'EFFECT_TYPE', 'EFFECT_CERTAINTY', 'THREAT_CATEGORY', 'THREAT_TYPE', 'THREAT_PROBABILITY', 'THREAT_INFERENCE_MAKING_ASSESSOR_NAME', 'INTERVENTION_ACTIVITY_TYPE', 'RECOMMENDATION_TYPE', 'PRIORITY_TYPE', 'RELATED_DETAILED_CONDITION_RESOURCE', 'TOPOGRAPHY_TYPE', 'LAND_COVER_TYPE', 'LAND_COVER_ASSESSMENT_DATE', 'SURFICIAL_GEOLOGY_TYPE', 'DEPOSITIONAL_PROCESS', 'BEDROCK_GEOLOGY', 'FETCH_TYPE', 'WAVE_CLIMATE', 'TIDAL_ENERGY', 'MINIMUM_DEPTH_MAX_ELEVATION_M_', 'MAXIMUM_DEPTH_MIN_ELEVATION_M_', 'DATUM_TYPE', 'DATUM_DESCRIPTION_EPSG_CODE', 'RESTRICTED_ACCESS_RECORD_DESIGNATION']
